          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>Wellyf</span>ShoppingCorp.</h1>
                  <h2>DRESSES,SHOES, BAGS</h2>
                  <p>Shop anytime of your own interest </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>Wellyf</span>ShoppingCorp.</h1>
                  <h2>WONDROUS COLLECTIONS</h2>
                  <p>Make your life colourful with our amazing products.</p>
